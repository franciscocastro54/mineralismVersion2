...
<div className={'row'}>
<div className={'col sinpadd'}><Lista_flujos type={'Alimentación'}/></div>
<div className={'col sinpadd'}><Lista_flujos type={'Cola'}/></div>
<div className={'col sinpadd'}><Lista_flujos type={'Relave'}/></div>
</div>
<div className={'row'}>
