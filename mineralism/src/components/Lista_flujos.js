    ...
    return <>
        <div className={'container-xxl border '}  >
            ...
            <div className={'row'}>
                ...
                <div className={'col-2'}>
                    <button data-bs-toggle={"modal"} title='agregar flujo'
                    className={'btn'}    data-bs-target={"#Modal" + type} onClick={() => {/*addCelda()*/; openCelda() }}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-plus-square-fill" viewBox="0 0 16 16">
            ...
            <div className={'row p-3'}>
                ...
                <ul className={'list-group scrollspy-example'}>
                    {list.map(
                        (list) => {
                            return <li className={"p-1"}><button type={"button"} className={"col-12 btn btn-primary"} data-bs-toggle={"modal"}
